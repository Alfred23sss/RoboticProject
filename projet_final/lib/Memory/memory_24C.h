...
// Description du programme: memory_24C.h defini la classe Memoire24CXXX qui permet d'interagir avec une mémoire EEPROM 24CXXX sur le
//microcontrôleur. Son constructeur initialise la mémoire et elle offre des méthodes pour choisir un banc de mémoire, lire et écrire 
//des données individuelles ou des blocs de données via le bus I²C.
